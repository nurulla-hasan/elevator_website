...
export default function VendorFilter() {
  ...
  const { updateFilter, getFilter, toggleFilter, updateBatch, isSelected, clearAll } =
    useSmartFilter();
  ...
  }, [getFilter("searchTerm"), getFilter("location"), getFilter("min"), getFilter("max")]);
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              >
                <SlidersHorizontal className={cn("h-4 w-4 transition-transform duration-300", isRefineOpen && "rotate-180")} />
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-5 pt-1">
                  ...
                  <div className="flex items-center justify-between text-xs font-bold">
                    ...
                    <span className="text-primary font-bold">${budget[1].toLocaleString()}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {["0-50", "50-100", "100-200", "200+"].map((item) => (
                    <Button
                      key={item}
                      size="sm"
                      variant={isSelected("guests", item) ? "default" : "outline"}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 p-2 bg-muted/50 rounded-md border border-border">
                    ...
                    <span className="text-xs font-bold text-muted-foreground min-w-12.5">
                      {getFilter("rating") ? `${getFilter("rating")} & up` : "Any"}
                    </span>
                  </div>
                </div>

                <div className="flex items-center gap-3 group cursor-pointer" onClick={() => toggleFilter("verified", "true")}>
                  <Checkbox
                    id="verified-only"
