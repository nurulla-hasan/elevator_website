...
export default function ChatWindow({ conversation, onBack }: ChatWindowProps) {
  return (
    <div className="flex flex-col h-full bg-background w-full ml-500">
      {/* Chat Header */}
      <div className="flex items-center justify-between sm:px-4 py-4 border-b bg-muted backdrop-blur supports-backdrop-filter:bg-background/60">
