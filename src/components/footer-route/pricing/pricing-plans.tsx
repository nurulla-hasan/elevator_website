...
const plans = [
  {
    ...
    price: "999",
    description: "Perfect for couples who need a head start with vendor selection.",
    features: [
  ...
  },
  {
    ...
    price: "2499",
    description: "Our most popular plan for comprehensive support from start to finish.",
    features: [
  ...
  },
  {
    ...
    price: "4999",
    description: "Ultimate luxury planning with full-service management and on-site support.",
    features: [
